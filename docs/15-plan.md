...
Статус: **этапы 0–4 выполнены.** Этап 0 — CMS-слой, imgproxy и Meilisearch удалены из кода,
...
WebGL2-рендерер с фолбэками. Следующий — этап 5 (переход intro → background и полировка).
